...
function sumArray(sumArr) { //eslint-disable-line
  var bigSum = sum(sum(testArray[0],testArray[1])[0],testArray[2])[0];

  return [bigSum, testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + bigSum + ' is their sum.'];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var bigMult = multiply(multiply(testArray[0],testArray[1])[0],testArray[2])[0];

  return [bigMult, 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + bigMult + '.'];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < dynamicArray.length; i++) {
    bigMult = multiply(bigMult, dynamicArray[i])[0];
    arrayString = arrayString + dynamicArray[i] + ',';
  }
  arrayString = arrayString.slice(0,-1);

  return [bigMult,'The numbers ' + arrayString + ' have a product of ' + bigMult + '.'];
}
